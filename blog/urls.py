...
from blog.views import (BlogPostAdminView, BlogPostCreateView,
                        BlogPostDeleteView, BlogPostDetailView,
                        BlogPostListView, BlogPostStatusToggleView,
                        BlogPostUpdateView)
...
urlpatterns = [
    ...
    path('blog_admin_page/', BlogPostAdminView.as_view(), name='admin_page'),
    ...
    path('blog_admin_page/<int:pk>/', BlogPostStatusToggleView.as_view(), name='toggle_status'),
